...
<div v-for="icecream in icecreams" :key="icecream.id" > 
  <blog-ice-cream @icecream-popup="toggleVisibility" :icecream="icecream" @delete="deleteIcecream" ></blog-ice-cream></div> 
      ...
      try {
        const res = await fetch(`${this.url}/${icecream.id}`, {
          ...
          body: JSON.stringify({
            ...
            username:  icecream.username,
            email:  icecream.email,
